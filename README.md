...
실행조차 불가능한 경우
* `아무 것도 없잖아 임마!`  
무언가 있어야 하는 것이 비어있는 경우
* `[키워드/숫자/기호]는 안돼 임마!`  
이름이 이름 규칙을 따르지 않는 경우
* `뭐 이런 그지 값이 다 있어?`  
대입/연산/비교 중 오류가 난 경우
* `너 지금 뭐하니?`  
조건문 선언/실행 등의 과정에서 오류가 난 경우
* `죽이고싶은 멘트`  
횟수 반복문 선언/실행 등의 과정에서 오류가 난 경우
* `인 방송 중에는!`  
조건 반복문 선언/실행 등의 과정에서 오류가 난 경우
* `만나면 나쁜 친구~`  
탈출할 제어문이 없는데 탈출을 시도할 경우
* `뭉탱이로 유링게슝`  
함수 선언/실행 등의 과정에서 오류가 난 경우
* `그 뒤는 안돼 임마!`  
리턴 과정에서 오류가 난 경우
